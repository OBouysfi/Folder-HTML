                    ...
                    series: [
                        {
                            ...
                            data: [
                                { value: 700, name: "Marketing" },
                                { value: 100, name: "RH" },
                                { value: 800, name: "Finance" },
                                { value: 200, name: "Ingénierie" },
                                { value: 200, name: "Juridique" },
                                { value: 300, name: "Logistique" },
                            ],
                    ...
                    series: [
                        {
                            ...
                            label: { show: !1, position: "left" },
                            emphasis: { label: { show: !0, fontSize: "16", fontWeight: "bold" } },
                            data: [
                                { value: 70, name: "Realisé" },
                                { value: 30, name: "Non Réalisé" },
                            ],
                        },
                    ],
                    textStyle: { fontFamily: "Poppins, sans-serif" },
...
//createChart('x1x', [10,20,30,40,50,60,70]);

function createChart(elt, data) {
    var myChart = echarts.init(elt);
    option = {
        tooltip: { trigger: "item" },
        series: [
            {
                name: "Access From",
                type: "pie",
                color: JSON.parse(elt.dataset.colors),
                label: { show: !1, position: "left" },
                emphasis: { label: { show: !0, fontSize: "16", fontWeight: "bold" } },
                data: elt.dataset.values,
            },
        ],
        textStyle: { fontFamily: "Poppins, sans-serif" },
    };
...
var els = document.getElementsByClassName("chart-quiz");
